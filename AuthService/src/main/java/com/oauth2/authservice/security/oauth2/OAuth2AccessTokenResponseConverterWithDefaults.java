package com.oauth2.authservice.security.oauth2;
...
public class OAuth2AccessTokenResponseConverterWithDefaults implements Converter<Map<String, String>, OAuth2AccessTokenResponse> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OAuth2AccessTokenResponseConverterWithDefaults.class);
